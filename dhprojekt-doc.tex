...
Das Ziel des Vergleichs war es, mit einem MUC-Scorer anhand der Werte Precision, Recall und F-Score 
...
und \emph{Reconcile} hat sich dann die  für die Testdaten angeboten. %TODO clemens: hier fehlt ein wort nach ``dann die''
